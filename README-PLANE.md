> **Snapshot of the upstream [Plane](https://plane.so) README, preserved at the point of our fork.**
> For current Plane documentation, see [plane.so](https://plane.so),
> [docs.plane.so](https://docs.plane.so), and the upstream repository
> [makeplane/plane](https://github.com/makeplane/plane).
> This file exists as attribution and as a pointer to Plane's own docs — it is not
> kept in sync with upstream.
> Looking for our project's README? → [README.md](./README.md).
