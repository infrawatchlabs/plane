/**
 * PP-71: Agent Docs — workspace home page.
 *
 * Renders the editor pane for the currently selected doc, or an empty
...
function AgentDocsHomePage() {
  const { workspaceSlug, selectedPath, bumpListVersion } = useAgentDocsContext();
    ...
    return (
      <div className="flex size-full flex-col items-center justify-center gap-4 text-center">
        ...
        <div className="flex flex-col gap-1">
          <h2 className="text-xl font-semibold text-primary">Agent Docs</h2>
...
export default AgentDocsHomePage;
