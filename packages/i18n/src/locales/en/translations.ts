...
export default {
  ...
  epics_description: "Group and track large features that span multiple work items.",
  ...
  epic_created_successfully: "Epic created successfully",
  draft_creation_failed: "Draft creation failed",
  issue_creation_failed: "Work item creation failed",
  epic_creation_failed: "Epic creation failed",
